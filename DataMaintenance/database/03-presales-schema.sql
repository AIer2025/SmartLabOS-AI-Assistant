...
CREATE TABLE IF NOT EXISTS `SmartLabOS-PresalesProject` (
    ...
    `challenges`      JSON                                 COMMENT '6.2.3 客户挑战(字符串数组, ≤10项, 每项≤200字)',
    `expectations`    JSON                                 COMMENT '6.2.4 客户期望(字符串数组, ≤10项, 每项≤200字)',
...
CREATE TABLE IF NOT EXISTS `SmartLabOS-PresalesGeneration` (
    ...
    `output_files`  JSON                                 COMMENT '生成的文件名数组(*.html / *-URS.html)',
