...
## Purpose (用途说明)
本模块是专为 50ml 尖底离心管设计的自动化开合盖执行单元，用于实验室、自动化产线中离心管的开盖、合盖、夹紧、取放瓶等标准化操作，可配合机械手或人工实现无人 / 少人化拆盖作业
