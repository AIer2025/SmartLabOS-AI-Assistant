...
resource_summary:
  total_modules_used: 6                   # 自动核算
  total_trays_used: 6                     # 自动核算
  total_power_kva_peak: 4.1               # 自动核算
  ventilation_required: false             # 自动核算
  compressed_air_required: true           # 自动核算
  water_required: false                   # 自动核算
